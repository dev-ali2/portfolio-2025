...
import 'package:portfolio_2025/app/projects/presentation/widgets/m_project_detail_popup.dart';
import 'package:portfolio_2025/core/common/models/featured_work_model.dart';
import 'package:portfolio_2025/helpers/colors_helper.dart';
import 'package:portfolio_2025/helpers/fonts_helper.dart';

class MProjectWidget extends StatelessWidget {
  final FeaturedProjectModel project;
  const MProjectWidget({super.key, required this.project});
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TextButton(
                ...
                onPressed: () {
                  Get.dialog(MProjectDetailPopup(project: project));
                },
                child: Text(
                  'View Info',
